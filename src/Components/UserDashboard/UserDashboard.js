                ...
                <div className="col-xl-4 col-sm-10 py-5">
                    <div className="card text-white bg-dark h-110">
                        <div className="card-body bg-dark">
                            ...
                            <h6 className="text-uppercase">Water connection Registration</h6><br></br><br></br><br></br>
                            <h1 className="display-4"> </h1>
                            <button className="btn btn-danger" onClick={()=>{
                                        navigate("/UserDashboard/UserConnection/Form1");
                ...
                <div className="col-xl-4 col-sm-5 py-5">
                    <div className="card text-white bg-info h-100">
                        <div className="card-body bg-info">
                            ...
                            <div className="text-uppercase">Water release schedule</div><br></br><br></br><br></br>
                            <h1 className="display-4"> </h1>
                            <div className="btn1">
                                <left><button className="btn btn-danger" onClick={()=>{
                                        navigate("/UserDashboard/WaterSchedule/Schedule");
                                    }}>Show</button></left>
                            </div>
                        </div>
                    </div>
